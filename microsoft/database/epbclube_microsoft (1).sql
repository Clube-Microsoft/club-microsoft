...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Abr-2019 às 00:59
...
--
-- Estrutura da tabela `estat_blog`
--

CREATE TABLE `estat_blog` (
  `id_estat_blog` int(30) NOT NULL,
  `n_estatic` int(30) NOT NULL,
  `data` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `estat_blog`
--

INSERT INTO `estat_blog` (`id_estat_blog`, `n_estatic`, `data`) VALUES
(58, 1, '2019-04-13 17:05:51'),
(59, 1, '2019-03-05 18:05:51'),
(60, 1, '2019-04-13 17:30:18'),
(61, 1, '2019-04-13 17:30:31'),
(62, 1, '2019-04-13 17:30:33');

-- --------------------------------------------------------

--
-- Estrutura da tabela `estat_index`
--

CREATE TABLE `estat_index` (
  `id_estat_index` int(30) NOT NULL,
  `n_estatic` int(30) NOT NULL,
  `data` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `estat_index`
--

INSERT INTO `estat_index` (`id_estat_index`, `n_estatic`, `data`) VALUES
(42, 1, '2019-04-13 16:31:57'),
(59, 1, '2019-03-27 18:30:35'),
(60, 1, '2019-02-12 18:53:05'),
(61, 1, '2019-04-13 17:53:06');
...
--
-- Indexes for table `estat_blog`
--
ALTER TABLE `estat_blog`
  ADD PRIMARY KEY (`id_estat_blog`);

--
-- Indexes for table `estat_index`
--
ALTER TABLE `estat_index`
  ADD PRIMARY KEY (`id_estat_index`);
...
--
ALTER TABLE `blog_post`
  MODIFY `Id_Post` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `estat_blog`
--
ALTER TABLE `estat_blog`
  MODIFY `id_estat_blog` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT for table `estat_index`
--
ALTER TABLE `estat_index`
  MODIFY `id_estat_index` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `hastags`
--
ALTER TABLE `hastags`
  MODIFY `Id_Hastags` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
COMMIT;
