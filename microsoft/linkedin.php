                        ...
                        <div class="meta-details">
                           ...
                           <div class="user-details row">
                              <ul class="social-links col-12">
                                 <li data-href="http://clubemicrosoftepb.pcriot.com/linkedin.php"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fclubemicrosoftepb.pcriot.com%2linkedin.php%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><i class="fa fa-facebook"></i></a></li>
                                 <li><a target="_blank" href="https://twitter.com/intent/tweet?text=http://clubemicrosoftepb.pcriot.com/linkedin.php Dotar os alunos de conhecimentos e competências para a utilização eficaz do LinkedIn. No final do workshop, o aluno deverá ser capaz de formular o seu perfil de maneira a efetuar a suacandidatura às ofertas de emprego."><i class="fa fa-twitter"></i></a></li>
                                 <li><a onclick="linkedin(event, 'http://clubemicrosoftepb.pcriot.com/linkedin.php', 'Clube Microsoft');return false;"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                 <li><a href="https://plus.google.com/share?url=http://clubemicrosoftepb.pcriot.com/linkedin.php"><i class="fa fa-google-plus"></i></a></li>
                                 <li><a target="_blank" href="whatsapp://send?text=Dotar os alunos de conhecimentos e competências para a utilização eficaz do LinkedIn. No final do workshop, o aluno deverá ser capaz de formular o seu perfil de maneira a efetuar a suacandidatura às ofertas de emprego. &ndash; http://clubemicrosoftepb.pcriot.com/linkedin.php" title="Acesse de seu smartphone para enviar por WhatsApp"><i class="fa fa-whatsapp"></i></a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
