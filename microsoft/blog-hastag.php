		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 posts-list">
					<?php
					$sql4      = "SELECT * FROM hastags where Hastag='$hastag2'";
					$consulta4 = mysqli_query($conn, $sql4);
					if ($consulta4->num_rows > 0) {
						while ($row4 = $consulta4->fetch_assoc()) {

							$Id_Post1 = $row4['Id_Post'];

							$sql      = "SELECT Id_Post, Titulo, Url_Clean, Texto_Pequeno, Texto_Grande, Img_Post, date_format(Data, '%d/%m/%Y') AS Data  FROM blog_post where Id_Post='$Id_Post1' ORDER BY blog_post.Data DESC LIMIT $num_posts, $posts_pag ";
